const landmarksCollection = [  
    { id: 1,
      name: "Taktsang Monastery",
      image: "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/1d/12/9d/bb/view-from-far.jpg?w=800&h=-1&s=1",
      description:"Precariously perched on the edge of a 3937 feet (1,200 meter) cliff, this monastery creates an impressive sight, and is the unofficial symbol of Bhutan. It is about 2-3 hour, entirely up-hill hike from the parking lot to the monastery.",
      pointsOfInterest:["Taktsang Cafeteria"]
    },
    { id: 2,
