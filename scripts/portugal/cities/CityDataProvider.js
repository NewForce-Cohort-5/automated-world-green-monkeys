const cityCollection = [
    { id: 1,
      ...
      pointsOfInterest: ["Belém Tower", "Castelo de S. Jorge", "Oceanário de Lisboa"
      //// this bit of code is commented out because i went with simply listing location names instead of breaking it down further.  
            // {
            //     name:"Belém Tower",
    ...
    { id: 2,
      ...
      pointsOfInterest: ["Livraria Lello", "Luís I Bridge", "Bolsa Palace"
      //// this bit of code is commented out because i went with simply listing location names instead of breaking it down further.  
            // {
            //     name:"Livraria Lello",
    ...
    { id: 3,
      ...
      pointsOfInterest: ["Bom Jesus do Monte", "Peneda-Gerês National Park", "Biscainhos Museum"
        //// this bit of code is commented out because i went with simply listing location names instead of breaking it down further.      
            // {
